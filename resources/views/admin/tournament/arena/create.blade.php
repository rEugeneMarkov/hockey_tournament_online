    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('admin.tournament.arena.store', $tournament->id) }}" method="POST">
                            @csrf
                            <div class="form-group w-25">
                                ...
                                <textarea type="text" class="form-control" name="info" placeholder="Информация">{{ old('info') }}</textarea>
                                @error('info')
                                    <div class="text-danger">Это поле необходимо для заполнения</div>
                                @enderror
